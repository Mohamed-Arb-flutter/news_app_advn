...
class WelcomeViwe extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Container(height: 330, child: Image.asset(AppAssets.home)),
          Expanded(
            child: Container(
              height: 500,
              ...
              child: Padding(
                ...
                child: Expanded(
                  child: Column(
                    children: [
                      SizedBox(height: 10),
                      Text('Get The Latest News\nAnd Updates',style:AppTextStyle.hedwel ,),
                      SizedBox(height: 5),
                      Text(
                        'From Politics to Entertainment: Your One-Stop Source for Comprehensive Coverage of the Latest News and Developments Across the Glob will be right on your hand.',style: AppTextStyle.parwel,
                      ),
                      SizedBox(height: 10),
                      CusatomBottom(
                        text: "Explore",
